...
Dockbot runs on Heroku and connects to Docker's Slack. `master` is automatically deployed to Heroku by [Wercker](https://app.wercker.com/#applications/54b7b4f43b3f059a3400004e). If you want access to the Wercker application, ask [bfirsh@docker.com](mailto:bfirsh@docker.com).
